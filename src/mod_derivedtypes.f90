...
!for each volume element. CellNumber referes to the cell WITHIN A PROCESSOR that the defect is located in.
!
...
module DerivedType
	...
	!to represent the entire mesh. This has been partially implemented to allow non-uniform meshes.
	!Volume added to mesh and boundaryMesh classes. Volume updated when cascades introduced or destroyed
	!Initially, volume=length**3, but the value of volume can be increased or decreased by adding or subtracting
	!fine meshes (adaptive meshing scheme) from the coarse mesh
	!***********************************************************************************************
	type mesh
	...
	!***********************************************************************************************
	!>Type: formationSingle. 2019.05.10 add.
	!
